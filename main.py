...
def lieux():
    ...
    screen.draw.text("appuyer sur a pour choisir le coupable", ((WIDTH/10)*8, 50))
...
def dialogue():
    global id_lieux, rep, position_curseur
...
def menu():
    ...
    screen.draw.text(u"MEURTRE A EIFFEL", ((WIDTH / 2) - 250, 100), color="black", fontname="algeria", fontsize=60)

    screen.draw.text(u"Appuyer sur entrée pour jouer", ((WIDTH / 2) - 250, HEIGHT - 200), color="black",
                     fontsize=60)
